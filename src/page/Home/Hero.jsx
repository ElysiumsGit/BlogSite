...
const Hero = () => {
  ...
  return (
    <div className="text-center py-12 px-6 bg-gradient-to-br from-pink-200 to-rose-100 rounded-lg">
      <h1 className="poppins-semibold text-6xl text-black mb-6">Your Gateway to Global News</h1>
      <h3 className="poppins-regular text-1xl text-black">Breaking Stories from Every Corner of the Globe</h3>
